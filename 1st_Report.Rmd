...
```{r, echo = F}
pacman::p_load(COVID19, tidyverse, tidymodels, workflows, tune, patchwork)
theme_set(theme_bw())
...
Due to the missing values, we have discontinuous plots. Therefore, we need a method to impute those missing values.
