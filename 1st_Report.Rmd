...
```{r}
spain_new_data <- COVID19::covid19(country = "spain", start = "2021-04-17")
```
...
2. Since our target variables are accumulated, we will consider the deaths and confirmed cases on each day and they will be divided by the total population and multiplied by 100000, to get the variables `deaths_100k` and `confirmed_100k`, i.e., the deaths and confirmed cases by 100k inhabitants on each day. 
