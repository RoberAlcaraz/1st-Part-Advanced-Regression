...
until now, having almost 2.5 million confirmed cases and around 67k deaths[@wiki].
...
The data has been taken from the R package `COVID19` [@guidotti2020]. These COVID-19 data sets contain 446 observations, which are the days from the 22nd of January 2020 until the 11th of March 2021, with 36 variables divided in 5 categories: *identifiers*, *COVID-19 variables*, *policy measures*, *geographic information* and *external keys*.
